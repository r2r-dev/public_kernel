...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		"uboot=u-boot.bin\0"			\
		"kernel=uImage\0"				\
		"bootargs_base=setenv bootargs console=ttymxc0,115200 console=ttyGS0,115200\0"\
		"bootargs_mmc=setenv bootargs ${bootargs} "     \
			"root=/dev/mmcblk0p1 rootfstype=ext4 rootwait\0"                \
		"bootcmd_mmc=run bootargs_base bootargs_video bootargs_mmc;" \
			"mmc read 2 0x70800000 0x2000 0x1000; bootm\0"   \
		"bootcmd=run bootcmd_mmc\0"                             \
		"bootargs_video=setenv bootargs ${bootargs} video=mxcepdcfb:E97_V110\0"   \
		"splashimage=0x800\0"
 ...
 */
#define CONFIG_SYS_PROMPT		"Onyx U-Boot > "
 ...
 */
	...
	#define CONFIG_ELINK_97_PANEL
	#define CONFIG_WORKING_BUF_ADDR			(TEXT_BASE + 0x100000)
	#define CONFIG_WAVEFORM_BUF_ADDR		(TEXT_BASE + 0x300000)
	#define CONFIG_WAVEFORM_FILE_OFFSET		0x200000
	#define CONFIG_WAVEFORM_FILE_SIZE		0x180000
	#define CONFIG_WAVEFORM_FILE_IN_MMC
#endif

#ifdef CONFIG_SPLASH_IS_IN_MMC
	#define CONFIG_SPLASH_IMG_OFFSET		0x100000
	#define CONFIG_SPLASH_IMG_SIZE			0xF1B30
#endif
...
#define CONFIG_ENV_SIZE         CONFIG_ENV_SECT_SIZE
	...
	#define CONFIG_ENV_OFFSET	(300 * 1024)
